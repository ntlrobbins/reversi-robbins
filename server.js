...
socket.on('join_room', (payload) => {
		serverLog('Server receieved a command','\'join_room\'',JSON.stringify(payload));
...
socket.on('invite', (payload) => {
		serverLog('Server receieved a command','\'invite\'',JSON.stringify(payload));
		/* Check that the data coming from the client is good */
		if ((typeof payload == 'undefined') || (payload === null)) {
			response = {};
			response.result = 'fail';
...
socket.on('uninvite', (payload) => {
		serverLog('Server receieved a command','\'uninvite\'',JSON.stringify(payload));
		/* Check that the data coming from the client is good */
		if ((typeof payload == 'undefined') || (payload === null)) {
			response = {};
			response.result = 'fail';
...
socket.on('game_start', (payload) => {
		serverLog('Server receieved a command','\'game_start\'',JSON.stringify(payload));
		/* Check that the data coming from the client is good */
		if ((typeof payload == 'undefined') || (payload === null)) {
			response = {};
			response.result = 'fail';
...
socket.on('send_chat_message', (payload) => {
		serverLog('Server receieved a command','\'send_chat_message\'',JSON.stringify(payload));
		/* Check that the data coming from the client is good */
		if ((typeof payload == 'undefined') || (payload === null)) {
			response = {};
			response.result = 'fail';
...
socket.on('play_token', (payload) => {
		serverLog('Server receieved a command','\'play_token\'',JSON.stringify(payload));
		/* Check that the data coming from the client is good */
		if ((typeof payload == 'undefined') || (payload === null)) {
			response = {};
			response.result = 'fail';
